...
root = Tk()
root.title('THE CONVERTER APP BY JOHN MARTIN')
root.geometry("450x400+100+200")
labelfont = ('ariel', 56, 'bold')
l = Label(root, text='THE CONVERTER APP', font=("TimesNewRoman", 20, "bold"), justify=CENTER)
l.place(x=80, y=20)
...
widget = Button(None, text="QUIT", bg="black", fg="red", font=("Arial", 14, "bold"), relief=RAISED, bd=5,
                ...
                activeforeground="black", command=root.destroy).place(x=350, y=350)
...
def CurrencyConverter():
    ...
    # To add drop-down for input unit
    ...
    # To add output field and drop-down
...
def WeightConverter():
    # factors to multiply a value to convert from the following units to meters(m)
    ...
    # function to convert a given unit to another unit
    def convert(amt, frm, to):
        if frm != 'g':
            amt = amt * factors[frm]
...
def AreaConverter():
    ...
    meterFactor = {'Square Meter': 1, 'Square Km': 1000000, 'Square Root': 1011.7141056, 'Square Cm': 0.0001,
                   'Square Foot': 0.09290304,
                   'Square Inch': 0.00064516, 'Square Mile': 2589988.110336, 'Milimeter': 0.000001,
                   'Square Root': 25.29285264,
...
widget = Button(root, text="Temperature Converter", bg="red", fg="yellow", font=("Arial", 14, "bold"), relief=RAISED,
                bd=5, justify=CENTER, highlightbackground="red", overrelief=GROOVE, activebackground="yellow",
                activeforeground="red", command=TemperatureConverter).place(x=120, y=120)
# LENGTH CONVERTER
widget = Button(root, text="Length Converter", bg="black", fg="white", font=("Arial", 14, "bold"), relief=RAISED, bd=5,
                justify=CENTER, highlightbackground="red", overrelief=GROOVE, activebackground="white",
                activeforeground="black", command=LengthConverter).place(x=50, y=180)
# AREA CONVERTER
widget = Button(root, text="Area Converter", bg="grey", fg="white", font=("Arial", 14, "bold"), relief=RAISED, bd=5,
                justify=CENTER, highlightbackground="red", overrelief=GROOVE, activebackground="white",
                activeforeground="grey", command=AreaConverter).place(x=120, y=240)
#CURRENCY CONVERTER
widget = Button(root, text="Currency Converter", bg="white", fg="green", font=("Arial", 14, "bold"), relief=RAISED, bd=5,
                justify=CENTER, highlightbackground="red", overrelief=GROOVE, activebackground="green",
                activeforeground="white", command=CurrencyConverter).place(x=50, y=60)
# WEIGHT CONVERTER
widget = Button(root, text="Weight Converter", bg="white", fg="red", font=("Arial", 14, "bold"), relief=RAISED, bd=5,
                justify=CENTER, highlightbackground="red", overrelief=GROOVE, activebackground="red",
                activeforeground="white", command=WeightConverter).place(x=50, y=300)
